...
export default function AchievmentGrid({ setCurrentGrid, animatedStyles }) {
  const [nameIdx, setNameIdx] = useState(0);
  const name = "Achievement".split("");

  const [subheadingIdx, setSubheadingIdx] = useState(0);
  const subheading = "Here are my some top Achievement...".split(
    ""
  );
    ...
    <animated.div className="grid grid-cols-1 lg:grid-cols-9 lg:grid-rows-9 w-screen lg:h-screen p-5 gap-5 bg-stone-200">
      ...
      >
        ...
        >
            ...
            id="home"
          >
            <span className="inline-block mx-2 animate-pulse" style={{color:'white'}}>
              Back To Home
            </span>
          </div>
